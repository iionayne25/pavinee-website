    ...
    <>
      ...
      <main className="flex flex-col gap-5 main mb-10 mt-5 md:mt-0">
        ...
        <div className="flex flex-col justify-end gap-5  md:flex-row items-center md:items-end ">
          ...
          <a
            href="https://interactive-rating-nextjs-by-pavinee.up.railway.app/"
            target="_blank"
          >
            <button className="btnLink text-base py-3  w-[330px] md:text-[16px] md:w-fit md:px-6 md:py-1">
              Visit Website
        ...
        <div className="flex flex-col lg:flex-row gap-2 justify-center items-center">
          <div className="space-y-2 lg:w-1/2 flex flex-col gap-2 justify-center items-center">
            ...
            />
            <Image
              src="/screenshots/interactive-rating-thankyou-desktop.jpg"
              width={450}
              height={500}
              alt="screenshot thankyou state desktop view image"
              className="rounded-xl"
            />
          ...
          <div className="lg:w-1/2 flex flex-col gap-2 justify-center items-center">
            <div className="flex flex-col md:flex-row gap-4">
              <Image
                ...
                width={200}
                height={120}
                alt="screenshot Interactive Rating mobile view image"
                className="rounded-xl self-center"
              />
              <Image
                src="/screenshots/interactive-rating-thankyou-mobile.jpg"
                width={200}
                height={120}
                alt="screenshot thankyou state mobile view image"
                className="rounded-xl self-center"
              />
            </div>
            <div>
