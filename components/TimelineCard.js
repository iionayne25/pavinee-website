...
const TimelineCard = () => {
  return (
      ...
      <div className="hidden md:block md:relative md:bg-greenLight md:w-[650px]   md:h-[450px]  md:rounded-2xl md:drop-shadow-xl
      lg:w-[750px]   lg:h-[450px]
      xl:w-[550px]  xl:left-5 xl:h-[330px]">
        <div>
          <Image
